...
class Minetest(gym.Env):
    ...
    def __init__(
        ...
        autostart_minetest: bool = False,
        minetest_dir: str = None,
    ):
        ...
        self.client_process = self.server_process = None
        if autostart_minetest:
            # Start Minetest server and client
            minetest_dir = minetest_dir or os.path.dirname(__file__)
            self.server_process = start_minetest_server(
                os.path.join(minetest_dir, "bin/minetest"),
                os.path.join(minetest_dir, "minetest.conf"),
                os.path.join(minetest_dir, "log"),
                os.path.join(minetest_dir, "newworld"),
            )
